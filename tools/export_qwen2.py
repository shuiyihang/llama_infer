...
def legacy_export(model, filepath):
    ...
    print("freqs_cos exists:", hasattr(model, "freqs_cos"))
    print("freqs_cos type:", type(model.freqs_cos))
    print("freqs_cos shape:", model.freqs_cos.shape)
    print("sliced shape:", model.freqs_cos[:p.max_seq_len].shape)
